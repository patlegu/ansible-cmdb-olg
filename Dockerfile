...
# docker run --rm -i -t -d --name CMDB -v $(pwd)/ansible-cmdb:/tmp/ansible-cmdb:z ansible-cmdb
# To connect to container:
# docker exec -i -t CMDB bash
...
RUN <<OEF
    ...
    mkdir /var/www/html/$DIRECTORY/log/
...
RUN echo "===> Linking new site"                 && \
    ln -s /etc/apache2/sites-available/ansible-cmdb.conf /etc/apache2/sites-enabled/ansible-cmdb.conf
